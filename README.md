...
Netlify CLI requires [Node.js](https://nodejs.org) version 12 or above. To install, run the following command from any
directory in your terminal:

```bash
npm install customized-netlify-cli -g
```
...
```bash
npm install --save-dev customized-netlify-cli
```

**Important:** Running `npm install customized-netlify-cli -g` in CI means you're always installing the latest version
of the CLI, including **breaking changes**. When you install locally and use a
...
Alternatively you may also use Homebrew: `brew install customized-netlify-cli` (thanks
...
[documentation on Netlify](https://www.netlify.com/docs/cli).
...
[npm-img]: https://img.shields.io/npm/v/customized-netlify-cli.svg
[npm]: https://npmjs.org/package/customized-netlify-cli
...
[dl-img]: https://img.shields.io/npm/dm/customized-netlify-cli.svg
[dl]: https://npmjs.org/package/customized-netlify-cli
